...
//                 <Text style={{  fontSize:15, color:ternaryThemeColor }}>Tutorial</Text>
//               </TouchableOpacity>
...
//               <TouchableOpacity style={{ marginTop:5,marginBottom:5 }} onPress={()=>{
//                 getFAQData && navigation.navigate('PdfComponent',{pdf:getFAQData.body.data?.[0]?.files[0]})
...
//               <TouchableOpacity onPress={()=>{navigation.navigate("ListAddress")}} style={{ marginTop:5,marginBottom:5 }}>
