    ...
    return (
        <View style={{alignItems:"center",justifyContent:"flex-start",height:'100%',backgroundColor:"white",width:"100%"}}>
            ...
            <View style={{flexDirection:"row",alignItems:"center",justifyContent:"center",width:'100%',marginTop:20}}>
                <View style={{height:50,padding:8,alignItems:"center",justifyContent:"center",flexDirection:"row",backgroundColor:'#FB774F',borderRadius:4,width:'44%'}}>
                ...
                <View style={{height:50,padding:8,alignItems:"center",justifyContent:"center",flexDirection:"row",backgroundColor:'black',borderRadius:4,width:'44%',marginLeft:14}}>
