...
import { useGetFormAccordingToAppUserTypeFormIdMutation, useGetFormMutation } from '../../apiServices/workflow/GetForms';
    ...
    return (
        <View style={styles.container}>
            ...
            <View
                ...
                <TouchableOpacity
                    style={{ height: 20, width: 20, position: 'absolute', left: '4%', marginTop: '4%' }}
                    onPress={() => {
                        navigation.goBack();
                    }}>
                    <Image
            ...
            <View style={{ marginTop: "20%", alignItems: 'center' }}>
                ...
                {
                    formArr && formArr?.map((item, index) => {
                ...
                {error && <ErrorModal modalClose={() => { onCloseModal()}} message={message} openModal={error}></ErrorModal>}
