...
const ScannedDetailsBox = (props) => {
    ...
    return (
        ...
        <PoppinsTextMedium style={{color:'white',fontSize:16}} content={t("Last Scanned Date")}></PoppinsTextMedium>
        <PoppinsTextMedium style={{color:'white',fontSize:16}} content={lastScannedDate}></PoppinsTextMedium>

        </View>
        <View style={{width:'50%',alignItems:'center',justifyContent:'center'}}>
        <PoppinsTextMedium style={{color:'white',fontSize:16}} content={t("Scan Count")}></PoppinsTextMedium>
