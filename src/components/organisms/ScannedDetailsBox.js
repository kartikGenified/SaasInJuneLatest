...
const ScannedDetailsBox = (props) => {
  const colorShades = useSelector(state=>state.apptheme.colorShades)
    ...
    return (
        ...
        <PoppinsTextMedium style={{color:'black',fontSize:16,fontWeight:'600'}} content="Last Scanned Date"></PoppinsTextMedium>
        <PoppinsTextMedium style={{color:'black',fontSize:16,fontWeight:'600'}} content={lastScannedDate}></PoppinsTextMedium>

        </View>
        <View style={{width:'50%',alignItems:'center',justifyContent:'center'}}>
        <PoppinsTextMedium style={{color:'black',fontSize:16,fontWeight:'600'}} content="Scan Count"></PoppinsTextMedium>
