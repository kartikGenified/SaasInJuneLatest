        ...
        <ScrollView style={{ height: '100%', width: '100%', flex: 1 }}>
            ...
            <Image style={{height:30,width:30,resizeMode:'contain'}} source={require('../../../assets/images/notificationOn.png')}></Image>
                ...
                <View style={{ width: '90%', alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: '#EEEEEE', borderRadius: 20, marginTop: 100 }}>
                    ...
                    {(getPointSharingData?.body?.total !=="0") ? <PoppinsTextMedium style={{ color:ternaryThemeColor, fontWeight:'bold' }} content={`Registration Bonus : ${getPointSharingData?.body?.data?.[0]?.points} Points`}></PoppinsTextMedium >
