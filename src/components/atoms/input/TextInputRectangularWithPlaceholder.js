...
const TextInputRectangularWithPlaceholder = (props) => {
    ...
    return (
        <View style={{height:60,width:'86%',borderColor:'#DDDDDD',alignItems:"center",justifyContent:"center",backgroundColor:'white',margin:10,borderWidth:0.6}}>
            ...
            <TextInput  maxLength={maxLength} onEndEditing={()=>{handleInputEnd(value)}} style={{height:50,width:'100%',alignItems:"center",justifyContent:"flex-start",fontWeight:'500',marginLeft:32,letterSpacing:1}} placeholderTextColor="#DDDDDD" onChangeText={(text)=>{handleInput(text)}} value={value} placeholder={placeHolder}></TextInput>
        </View>
    );
}
